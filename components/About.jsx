...
const infoData = [
    ...
    },
    {
        ...
        text: "Bhittai Colony Korangi Crossing Karachi, Sindh, Pakistan "
    },
]
  ...
  <div className="container mx-auto">
    ...
    <div className='flex flex-col xl:flex-row'>
        ...
        <div className='hidden xl:flex flex-1 relative'>
            <DevImg containerStyles='bg-about_Shape_light dark:bg-about_shape_dark w-[505px] h-[505px] bg-no-repeat relative' imgSrc='/personalimg.png'/>
        </div>
        {/* tabs */}
